  ...
  return (
    <div className="space-y-12">
      ...
      <section className="space-y-8">
        <h2 className="text-4xl md:text-5xl font-medium text-gray-900">About Me</h2>
      ...
      {/* Tech Stack Section */}
      <section className="space-y-8">
        <h2 className="text-3xl md:text-4xl font-medium text-gray-900">Tech Stack</h2>
        <div className="grid md:grid-cols-3 gap-8 py-4 border-b border-gray-200">
          {/* My Expertise */}
          <div className="space-y-4">
            <h3 className="text-xl font-light text-gray-900">My expertise</h3>
          ...
          {/* Databases */}
          <div className="space-y-4">
            <h3 className="text-xl font-light text-gray-900">DB</h3>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-white border border-gray-200 text-gray-800 text-sm rounded-full flex items-center gap-1">
          ...
          {/* Experienced In */}
          <div className="space-y-4">
            <h3 className="text-xl font-light text-gray-900">Experienced In</h3>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-white border border-gray-200 text-gray-800 text-sm rounded-full flex items-center gap-1">
      ...
      <section className="space-y-8">
        <div>
          <motion.a
            href="/cv.pdf#view=FitH"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-3 px-6 py-3 bg-gray-900 text-white rounded-xl hover:shadow-lg w-full justify-center"
      ...
      <section className="space-y-8">
        <div className="grid grid-cols-2 gap-8">
          {/* Contact Info */}
          <div className="space-y-4">
            <h3 className="text-xl md:text-3xl font-medium text-gray-900">Contact</h3>
          ...
          {/* Social Links */}
          <div className="space-y-4">
            <h3 className="text-xl md:text-3xl font-medium text-gray-900 text-center">Connect</h3>
            <div className="flex gap-4 items-center justify-center">
              <a
                href="https://github.com/tomasferreira66"
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center w-12 h-12 bg-gray-800 hover:bg-gray-900 rounded-full transition-colors"
                aria-label="GitHub"
              >
